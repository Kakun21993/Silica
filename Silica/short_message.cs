...
namespace version1
{
    public class short_message
    {
        public void story()
        {
            ...
            "Your PC is now infected and there is no escape." + 
            "You are no longer the owner of this system" + 
            "I take full control of your system, you can't get rid of me!" + 
            "You cannot destroy me with an antivirus," +
            "because I'M UNSTOPPABLE" + 
            "You only have a few minutes to survive!" +  
